...
static void ATL_trmv_scal(ATL_CSZT  N, const SCALAR alpha0, const TYPE *A,
                          ATL_CSZT lda, TYPE *X)
/*
 * X <- alpha * A * X
 */
...
void Mjoin(Mjoin(PATL,trinvertU),UnitNM)(ATL_CSZT  N, TYPE *A, ATL_CSZT lda)
{
   int j;
   register int i;
   const int ione=1;
...
#ifndef NoUse
void Mjoin(Mjoin(PATL,trinvertL),UnitNM)(ATL_CSZT  N, TYPE *A, ATL_CSZT lda)
{
   int j;
   register int i;
   const int ione=1;
