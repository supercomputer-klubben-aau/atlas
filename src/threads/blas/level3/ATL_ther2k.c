 ...
 */
   #if (3*ATL_VWipmen_BEST_LCMU > ATL_VWipmen_BEST_KB)
      #define ATL_MIN_KB_2K ATL_VWipmen_BEST_KB
   #else
      #define ATL_MIN_KB_2K 3*ATL_VWipmen_BEST_LCMU
   #endif
   if (N < 3*ATL_VWipmen_BEST_LCMN && K < ATL_MIN_KB_2K)
   {
