...
void *ATL_sipsycmpBV(int verb, double tol, ipinfo_t *ip, int flg, const TYPE *a,
                    ATL_iptr_t N, const TYPE *A);
void *ATL_sgecmpBV(int,double,int,int,const float*,int,const float*,int);
void *ATL_strcmpBV
   (int, double, const enum ATLAS_UPLO, int, int, const float*, int,
    const float*, int);
...
void Mjoin(PATL,ipprint)(FILE *fp, ipinfo_t *ip, int flg, char *nm,
                         ATL_iptr_t M, ATL_iptr_t N, const TYPE *w);
void *ATL_dipsycmpBV(int verb, double tol, ipinfo_t *ip, int flg, const TYPE *a,
                    ATL_iptr_t N, const TYPE *A);
void *ATL_dgecmpBV(int,double,int,int,const double*,int,const double*,int);
void *ATL_dtrcmpBV
   (int, double, const enum ATLAS_UPLO, int, int, const double*, int,
    const double*, int);
...
void Mjoin(PATL,ipprint)(FILE *fp, ipinfo_t *ip, int flg, char *nm,
                         ATL_iptr_t M, ATL_iptr_t N, const TYPE *w);
void *ATL_cipsycmpBV(int verb, double tol, ipinfo_t *ip, int flg, const TYPE *a,
                    ATL_iptr_t N, const TYPE *A);
void *ATL_cgecmpBV(int,double,int,int,const float*,int,const float*,int);
void *ATL_ctrcmpBV
   (int, double, const enum ATLAS_UPLO, int, int, const float*, int,
    const float*, int);
...
void Mjoin(PATL,ipprint)(FILE *fp, ipinfo_t *ip, int flg, char *nm,
                         ATL_iptr_t M, ATL_iptr_t N, const TYPE *w);
void *ATL_zipsycmpBV(int verb, double tol, ipinfo_t *ip, int flg, const TYPE *a,
                    ATL_iptr_t N, const TYPE *A);
void *ATL_zgecmpBV(int,double,int,int,const double*,int,const double*,int);
void *ATL_ztrcmpBV
   (int, double, const enum ATLAS_UPLO, int, int, const double*, int,
    const double*, int);
